...
def registerTechnologySwitching():
  from . import utils, _globals

  _globals.ACTIONS.append(pya.Observer())
  _globals.ACTIONS[-1].on_signal(utils.load_technology)
  pya.Application.instance().main_window().add_current_view_observer(_globals.ACTIONS[-1])
  pya.Application.instance().main_window().add_new_view_observer(_globals.ACTIONS[-1])
